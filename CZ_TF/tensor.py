...
train_df_main = pd.read_csv('./train_val_df.csv', index_col=0)
...
# Add GAN data
_ = pd.concat([train_df_main, train_df_main_agmented], ignore_index = True)
...
print(sum(auc_rocs_after) / len(auc_rocs_after))
print(final_result)
