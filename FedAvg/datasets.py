...
#         img[img > threshold] = 0
    ...
    def __init__(self, client_index = None, mode = 'train'):
        ...
        if mode == 'train':
            self.all_image_paths = glob.glob('C:/Users/hb/Desktop/Data/ChestX-ray14_Client_Data/C' + str(client_index) + '/*.png')
        if mode  == 'test':
            self.all_image_paths = glob.glob('C:/Users/hb/Desktop/Data/ChestX-ray14_Client_Data/test/*.png')
